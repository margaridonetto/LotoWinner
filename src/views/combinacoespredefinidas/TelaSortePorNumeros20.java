...
public class TelaSortePorNumeros20 extends javax.swing.JFrame {

    private int quantidade = 0;
    private ArrayList<Integer> numerosSelecionados = new ArrayList<Integer>();
    
    public TelaSortePorNumeros20() {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Escolha 20 números de sua preferência que vamos gerar 4 possíveis cartelas para você jogar!");

        jLabel5.setText("Será gerado 4 combinaçõens de 15 números cada, usando os números que você escolheu e garante 11 e 12  acertos se acertar os 15.");
    ...
    private void jTextField01MouseClicked(java.awt.event.MouseEvent evt) {                                          
        ...
        if (clicou) {
            ...
            if (quantidade < 20) {
                ...
                JOptionPane.showMessageDialog(null, "São Permitidos apenas 20 números!");
            }
        } else {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        if(quantidade == 20){
            ...
            if((20-quantidade) == 1){
                JOptionPane.showMessageDialog(null, "Você deve escolher mais " + (20 - quantidade) + " número!");
            }else{
                JOptionPane.showMessageDialog(null, "Você deve escolher mais " + (20 - quantidade) + " números!");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaSortePorNumeros20.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaSortePorNumeros20().setVisible(true);
            }
        });
    }
